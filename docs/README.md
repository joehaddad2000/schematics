...
Canvas Blocks is a skill repository.
...
| `skills/create-plan-canvas/SKILL.md` | Agent execution workflow and quality gate. |
| `skills/create-plan-canvas/references/*.md` | Detailed guidance loaded only when the task needs it. |
